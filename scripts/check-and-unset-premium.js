// Node.js script to check a user by email and set isPremium to false if currently true
// Usage: node scripts/check-and-unset-premium.js --email user@example.com
...
async function run() {
  ...
  try {
    ...
    if (!user.isPremium) {
      console.log('No change needed: user is already not premium.');
      return;
    }
