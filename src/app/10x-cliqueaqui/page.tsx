...
export default function Page() {
  useEffect(() => {
    const existing = document.getElementById(
      "vturb-player-script-68bf50b0d26d3f8096545617"
    ) as HTMLScriptElement | null;

    if (!existing) {
      const s = document.createElement("script");
      s.id = "vturb-player-script-68bf50b0d26d3f8096545617";
      s.src =
        "https://scripts.converteai.net/17e2196c-5794-49ef-bd61-857538a02fa6/players/68bf50b0d26d3f8096545617/v4/player.js";
      s.async = true;
      ...
      <main className="px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="w-full mx-auto">
            <VturbSmartPlayer
              id="vid-68bf50b0d26d3f8096545617"
