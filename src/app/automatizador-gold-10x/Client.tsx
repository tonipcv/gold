...
export default function AutomatizadorGold10xClient() {
  ...
  const episodes: Episode[] = [
    ...
    { id: 17, number: 16, title: 'ESTRATÉGIA COM TRAVA',                                                  playerId: '690a7938cb5344d7fad2af7b', accountId: '17e2196c-5794-49ef-bd61-857538a02fa6', locked: false },
  ]
