  ...
  return (
    <div className="text-gray-200">
      ...
      <div className="mb-6 text-center">
        ...
        <h1 className="mt-3 text-2xl md:text-[28px] font-semibold text-white tracking-tight">Preset Gold X</h1>
        <p className="mt-1 text-sm text-gray-400">Aprenda a instalar e configurar o Preset Gold X</p>
