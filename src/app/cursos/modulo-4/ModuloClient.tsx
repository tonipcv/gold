  ...
  return (
    <div className="text-gray-200">
      ...
      <div className="mb-6 text-center">
        ...
        <h1 className="mt-3 text-2xl md:text-[28px] font-semibold text-white tracking-tight">Falcon Bit</h1>
        <p className="mt-1 text-sm text-gray-400">Estratégia Falcon Bit</p>
