      ...
      <main className="pt-24 pb-20">
        <div className="w-full md:w-3/4 lg:w-3/4 md:mx-auto lg:mx-auto px-4 py-4">
          <div className="text-gray-200">
            {/* Header do Módulo */}
            <div className="mb-6">
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">MÓDULO 4 - FALCON BIT</h1>
              <p className="text-gray-400">Estratégia Falcon Bit</p>
            </div>
            ...
            <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-8 md:p-12 flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-3">MÓDULO - FALCON BIT</h2>
              <p className="text-gray-300 mb-6 max-w-md">
                Acesse os arquivos e materiais do módulo Falcon Bit
              </p>
              <a
                href="https://drive.google.com/drive/folders/1uaN5F57mOnm2JIunnWEZTPIwunFu7HwJ?usp=sharing"
                target="_blank"
