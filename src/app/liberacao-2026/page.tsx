  ...
  return (
    <div className="font-sans bg-black text-white min-h-screen relative overflow-hidden">
      <div className="relative z-10">
        ...
        {/* Plans Section */}
        <section id="planos" className="px-4 pt-10 pb-12 md:pt-16 md:pb-16 bg-black">
          <div className="max-w-5xl mx-auto">
            {/* Grid de Planos */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {/* Plano Mensal */}
              <div className="order-2 md:order-1 relative border border-neutral-800 rounded-2xl p-8 bg-transparent transition-all duration-200">
                <div className="text-center mb-6">
                  <h3 className="text-lg font-medium text-white">PLANO MENSAL</h3>
                  <div className="mt-2 text-xs text-neutral-400">80 vagas</div>
                  <ProgressBar percentage={23} color="red" />
                </div>
                ...
                <ul className="space-y-4 mb-8">
                  ...
                  <li className="flex items-start gap-3 text-sm"><span className="text-green-400 mt-1">✓</span><span className="text-white">Garantia de 7 dias para teste e reembolso total</span></li>
                </ul>

                <div className="text-center pt-6 border-t border-neutral-800/30">
                  <div className="text-2xl font-light text-white">R$ 447/mês</div>
                  
                  <div className="mt-6">
                    <a 
                      href="https://checkout.k17.com.br/subscribe/mensal10x"
                      target="_blank"
              ...
              {/* Plano Trimestral */}
              <div className="order-1 md:order-2 relative border border-neutral-800 rounded-2xl p-8 bg-transparent transition-all duration-200">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mt-2 text-xs text-neutral-400">35 vagas</div>
                  <ProgressBar percentage={89} color="red" />
                </div>
