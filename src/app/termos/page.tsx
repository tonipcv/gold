...
export const metadata = {
  title: "Termos de Uso – Gold 10x ou Power V2 (Versão Oficial)",
  description:
    "Termos de Uso oficiais da Versão Oficial do software/estratégia Gold 10x ou Power V2 disponibilizada pela LYS Metaverse.",
};
      ...
      <main className="px-4 py-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl md:text-3xl font-semibold text-center mb-2">
            Termos de Uso – Gold 10x ou Power V2 (Versão Oficial)
          </h1>
          <p className="text-center text-neutral-400 mb-10">Data: 26 de agosto de 2025</p>

          <p className="text-neutral-300 leading-relaxed mb-8">
            A versão oficial do software/estratégia Gold 10x ou Power V2 (“Versão Oficial”) é disponibilizada pela LYS Metaverse,
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              <li>
                O Gold 10x ou Power V2 consiste em um software/arquivo digital de estratégia automatizada para operações financeiras.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              <li>
                ...
                decorrentes do uso do Gold 10x ou Power V2.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              ...
              <li>
                O Gold 10x ou Power V2 é apenas uma ferramenta tecnológica automatizadora, não devendo ser interpretado como
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              <li>
                ...
                individual do Gold 10x ou Power V2.
              </li>
              <li>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  ...
                  <li>utilizar o Gold 10x ou Power V2 de forma que viole leis, regulamentos ou direitos de terceiros.</li>
                </ul>
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              <li>
                A LYS Metaverse poderá disponibilizar atualizações, correções e melhorias ao Gold 10x ou Power V2, a seu exclusivo critério.
              </li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              <li>
                A LYS Metaverse poderá suspender ou revogar o acesso do usuário ao Gold 10x ou Power V2 em caso de violação destes
                Termos de Uso.
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-neutral-300">
              ...
              <li>
                A LYS Metaverse não se responsabiliza por qualquer decisão de investimento tomada com base no uso do Gold 10x ou Power V2.
              </li>
            </ol>
          </section>
          ...
          <section className="mb-4">
            ...
            <p className="text-neutral-300 leading-relaxed">
              O Gold 10x ou Power V2 é uma ferramenta oficial e licenciada da LYS Metaverse, destinada a usuários que compreendem os riscos
